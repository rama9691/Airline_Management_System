...
public class BoardingPass extends JFrame implements ActionListener{
    ...
    public BoardingPass() {
        ...
        ImageIcon li=new ImageIcon(ClassLoader.getSystemResource("airlinemanagement/images/airindia.png"));
        Image i2 = li.getImage().getScaledInstance(300, 230, Image.SCALE_DEFAULT);
